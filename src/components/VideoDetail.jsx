...
const VideoDetail = () => {
  ...
  useEffect(() => {
    fetchFromAPI(`videos?part=contentDetails,snippet,statistics&id=${id}`).then(data => setVideoDetail(data.items[0]));
  ...
  // let {title, channelId, channelTitle} = snippet
  // let {viewCount, likeCount} = statistics
